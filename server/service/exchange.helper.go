...
func (e *ExchangeService) helperAddress(address string, platform proto.Platform) error {

	var regexMap = map[proto.Platform]string{
		proto.Platform_BITCOIN:  "^(bc1|[1b])[a-zA-HJ-NP-Z0-9]{25,39}$",
		proto.Platform_TRON:     "^([T])[a-zA-HJ-NP-Z0-9]{33}$",
		proto.Platform_ETHEREUM: "^(0x)[a-zA-Z0-9]{40}$",
	}
...
func (e *ExchangeService) helperSymbol(symbol string) error {
...
func (e *ExchangeService) helperPair(base, quote string) error {
...
func (e *ExchangeService) helperWithdraw(quantity, reserve, balance, max, min, fees float64) error {
...
func (e *ExchangeService) helperInternalAsset(address string) error {
	var (
		exist bool
	)
...
func (e *ExchangeService) helperOrder(order *proto.Order) (summary float64, err error) {
	...
	case proto.Assigning_BUY:
		...
		quantity := e.getQuantity(proto.Assigning_BUY, order.GetQuantity(), order.GetPrice(), false)
		...
		summary = e.getQuantity(proto.Assigning_BUY, balance, order.GetPrice(), true)
	...
	case proto.Assigning_SELL:
		...
		quantity := e.getQuantity(proto.Assigning_SELL, order.GetQuantity(), order.GetPrice(), false)
		...
		summary = e.getQuantity(proto.Assigning_SELL, balance, order.GetPrice(), true)
